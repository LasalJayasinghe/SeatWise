    ...
    <header className="bg-white">
      <nav className="flex items-center justify-between p-6 mx-auto max-w-7xl lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" className="text-sm font-semibold leading-6 text-gray-500 hover:text-green-500">
            Home
          </a>
          <a href="#" className="text-sm font-semibold leading-6 text-gray-500 hover:text-green-500">
            Restaurants
          ...
          <div className="flow-root mt-6">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="py-6 space-y-2">
                      ...
                      <Disclosure.Panel className="mt-2 space-y-2">
                        {[...products, ...callsToAction].map((item) => (
                          <Disclosure.Button
                            ...
                            as="a"
                            href={item.href}
                            className="block py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-500 rounded-lg hover:bg-gray-50"
                          >
                            {item.name}
                          </Disclosure.Button>
                        ))}
                ...
                <a
                  href="#"
                  className="block px-3 py-2 -mx-3 text-base font-semibold leading-7 text-gray-500 rounded-lg hover:text-green-500 hover:bg-gray-50"
                >
                  Home
                </a>
                <a
              ...
              <div className="py-6">
                <a
                  href="#"
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-500  hover:text-green-500 hover:bg-gray-50"
                >
                  Log in
                </a>
              </div>
