  ...
  <div class="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center mr-2">
    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">{meal.category.category}</h2>
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{meal.name}</h1>
        <div class="flex mb-4">
        ...
        <p class="leading-relaxed">{meal.description}</p>
...
<CounterInput/>
        ...
        <div class="flex items-center border-t border-gray-300 pt-4">
          <span class="title-font font-medium text-4xl text-gray-900"> LKR {meal.price}.00</span>
      ...
      <path d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
          ...
          <button class="flex ml-auto font-semibold text-white bg-green-500 border-0 py-3 px-4 focus:outline-none hover:bg-green-600 rounded-lg">Add meal &nbsp;&nbsp;&nbsp;
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
      <path d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
    </svg>
    </button>
